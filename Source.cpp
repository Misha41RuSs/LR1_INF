...
void task_a() {
    ...
    cin >> a >> b >> res1;   // Считывание данных из входного потока и занесение их в переменные
    double div;              // Переменная для результата деления с помощью ЭВМ
    div = a / b;             // Вычисление частного при помощи ЭВМ
    cout << "Введите число, из которого нужно извлечь квадратный корень и результат этого извлечения: ";
    double c, res2;          // Число, из которого извлекаем корень, результат извлечения корня
    cin >> c >> res2;        // Считывание данных из входного потока и занесение их в переменные
    ...
    */
    ...
    /*
     Вычисляем предельную абсолютную погрешность в процентах - умножаем полученный ранее резульат на 100 и делим на 
